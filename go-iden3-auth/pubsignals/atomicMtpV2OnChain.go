...
// AtomicQueryMTPV2OnChain is a wrapper for circuits.AtomicQueryMTPV2OnChainPubSignals.
type AtomicQueryMTPV2OnChain struct {
	circuits.AtomicQueryMTPV2OnChainPubSignals
}

// VerifyQuery checks whether the proof matches the query.
func (c *AtomicQueryMTPV2OnChain) VerifyQuery(
	ctx context.Context,
	query Query,
...
func (c *AtomicQueryMTPV2OnChain) VerifyStates(ctx context.Context, stateResolvers map[string]StateResolver, opts ...VerifyOpt) error {
...
func (c *AtomicQueryMTPV2OnChain) VerifyIDOwnership(sender string, requestID *big.Int) error {
